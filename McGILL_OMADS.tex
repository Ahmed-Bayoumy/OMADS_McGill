...
%-------------------------------------%
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{block}<1-4>{Definition: Pareto dominance}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        domain=0:1,
          ...
          \only<2>{\addplot[mark=only marks, color=black!, mark=*,] coordinates {(0.6,0.6)};}
          \only<3>{\addplot[mark=only marks, color=black!, mark=*,] coordinates {(0.4,0.4)};}

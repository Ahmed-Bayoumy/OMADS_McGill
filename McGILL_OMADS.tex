...
\usepackage{hyperref}
\usepackage{bookmark}
\newcommand{\fadecolor}[3]{%
  \tikz[baseline=(text.base)]{
    \node[outer sep=0pt, fill=none] (text) {\textcolor{#1}{#2}};%
    \foreach \i in {1, ..., 10} {%
      \pgfmathsetmacro{\mixcolor}{#1!((11-\i)*100/10)+#3!((\i)*100/10)}%
      \node[outer sep=0pt, fill=none, opacity=1-\i/10] at (text.north) {\textcolor{\mixcolor}{#2}};%
    }
  }%
}
...
{\begin{itemize}
  \item {What is blackbox optimization?}
  \vspace{0.5cm}
  \item {\color{mygray} Functions differentiability}
  \vspace{0.5cm}
  \item {\color{mygray} Direct search methods}
  \vspace{0.5cm}
  \item {\color{mygray} Mesh adaptive direct search method}
  \vspace{0.5cm}
  \item {\color{mygray} Multiobjective optimization using MADS}
  \vspace{0.5cm}
  \item {\color{mygray} Implementations}
  \end{itemize}}
\end{frame}
...
\begin{frame}{}
  \begin{itemize}
  \item {\color{mygray} What is blackbox optimization?}
  \vspace{0.5cm}
  \item {Functions differentiability}
  \vspace{0.5cm}
  \item {\color{mygray} Direct search methods}
